...
export default class ImportInjector {
  ...
  addDefault(importedSourceIn, opts, types) {
    return this.addNamed("default", importedSourceIn, opts, types);
  }

  addNamed(importName, importedSourceIn, opts, types) {
  ...
  addNamespace(importedSourceIn, opts, types) {
    return this._generateImport(
      this._applyDefaults(importedSourceIn, opts),
      null,
      types,
  ...
  addSideEffect(importedSourceIn, opts, types) {
    return this._generateImport(
      this._applyDefaults(importedSourceIn, opts),
      false,
      types,
  ...
  _generateImport(opts, importName, types: typeof t) {
    ...
    if (
      ...
      return types.sequenceExpression([types.numericLiteral(0), resultName]);
    }
    return resultName;
  }
